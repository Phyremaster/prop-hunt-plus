...
------------------------------------------------------
-- THESE LINES HAVE BEEN ADDED FOR PROP HUNT PLUS   --
include("lps_init.lua")                             --
include("rotator_init.lua")                         --
-- THESE LINES INCLUDE THE PROP HUNT PLUS LUA FILES --
------------------------------------------------------
...
function GM:CheckPlayerDeathRoundEnd()
	...
	if table.Count(Teams) == 1 then
		...
		-- THIS WAS REPLACED TO DISPLAY THE CORRECT TEAM IN THE WIN MESSAGE: team.GetName(1) --> team.GetName(TeamID) --
        ----------------------------------------------------------------------------------------------------------------
...
function GM:PlayerCanPickupWeapon(pl, ent)
    ...
    -----------------------------------------------------------------------
    -- THESE LINES HAVE BEEN ADDED FOR PROP HUNT PLUS LAST PROP STANDING --
    local propCount = 0                                                  --
    ...
    -- THESE LINES COUNT THE NUMBER OF PROPS THAT ARE STILL ALIVE        --
    -----------------------------------------------------------------------

    ---------------------------------------------------------------------------------------------------------------
    -- THIS LINE HAS BEEN MODIFIED FOR PROP HUNT PLUS LAST PROP STANDING                                         --
    if (pl:Team() != TEAM_HUNTERS) and !((pl:Team() == TEAM_PROPS) and (propCount == 1)) then                    --
    -- THIS WAS ADDED TO ALLOW PROPS TO BE GIVEN A MAGNUM: and !((pl:Team() == TEAM_PROPS) and (propCount == 1)) --
    ---------------------------------------------------------------------------------------------------------------
